  ...
  getRequestUrlByType(type){
    ...
    switch (type.toUpperCase()) {
      ...
      case 'VOCPOLLUTION':
        cf = apiConfig[0];
        // url = 'http://117.119.97.150:8063/api/XhHb/GetXhHbPoint';
        url = 'http://gkpt.zq12369.com:8016/api/XhHb/GetXhHbPointsVoc';//cf.site + cf.port + cf.path + 'api/XhHb/GetXhHbPointsVoc';
        break;
      case 'SENSECHART':
        cf = apiConfig[0];
      ...
      case 'VOCCHART':
        ...
        url = 'http://gkpt.zq12369.com:8016/api/XhHb/GetXhHistoriesVoc';//cf.site + cf.port + cf.path + 'api/XhHb/GetXhHistoriesVoc';
        break;
      case 'DUSTPOLLUTION':
        cf = apiConfig[0];
      ...
      case 'TOWNPOLLUTION':
        cf = apiConfig[0];
        url = cf.site + cf.port + cf.path + 'api/Town/GetTownList?region='+encodeURI('固安');
        break;
      case 'TOWNCHART':
        cf = apiConfig[0];
